...
def predict():
    ...
    if request.method == 'POST':
        ...
        sample_result = {"age": age, "sex": sex, "steroid": steroid, "antivirals": antivirals, "fatigue": fatigue,
                         ...
                         "histolog": histology}
        single_data = [age, sex, steroid, antivirals, fatigue, spiders, ascites, varices, bilirubin, alk_phosphate,
    ...
    return render_template("index.html", sample_result=sample_result, prediction=final_result,
                           pred_probalility_score=pred_probalility_score)
...
def api_predict():
        ...
        steroid = request.args['steroid']
        antivirals = request.args['antivirals']
        fatigue = request.args['fatigue']
        spiders = request.args['spiders']
        ascites = request.args['ascites']
        varices = request.args['varices']
        bilirubin = request.args['bilirubin']
        alk_phosphate = request.args['alk_phosphate']
        sgot = request.args['sgot']
        albumin = request.args['albumin']
        protime = request.args['protime']
        histology = request.args['histology']
        sample_result = {"age": age, "sex": sex, "steroid": steroid, "antivirals": antivirals, "fatigue": fatigue,
                         "spiders": spiders, "ascites": ascites, "varices": varices, "bilirubin": bilirubin,
                         "alk_phosphate": alk_phosphate, "sgot": sgot, "albumin": albumin, "protime": protime,
                         "histolog": histology}
